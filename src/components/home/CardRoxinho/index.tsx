...
export default function CardRoxinho() {
  return (
    <Link className="block w-full" href="#">
      <Card
        className="cursor-pointer relative w-full h-full min-h-40 duration-300 ease-out shadow-2xl hover:shadow-none hover:translate-y-3 items-center justify-center
